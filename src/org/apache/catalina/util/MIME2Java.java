...
/**
 * MIME2Java处理MIME字符集的名字和java编码名称之间的转换.
 * <p>支持XML编码是XML支持代码集和那些在JDK 1.1支持的交集.
 * <p>MIME字符集名称在<var>xmlEncoding</var>方法参数上使用, 例如<code>TXDocument#setEncoding</code>和<code>DTD#setEncoding</code>.
 * <p>java编码名称在 <var>encoding</var>方法参数上使用, 例如<code>TXDocument#printWithFormat</code>和<code>DTD#printExternal</code>.
 * <P>
...
public class MIME2Java {
    ...
    /**
     * 转换一个MIME字符集名称, 也称为XML编码名, 一个java的编码名称.
     * @param   mimeCharsetName MIME字符集名称不区分大小写: <code>UTF-8, US-ASCII, ISO-8859-1,
     ...
     * @return                  java的编码名称, 或者<var>null</var>如果<var>mimeCharsetName</var>未知.
     */
    ...
    /**
     * 将一个java编码名称转换为MIME字符集名称.
     * <i>encoding</i>可用值是 "UTF8", "8859_1", "8859_2", "8859_3", "8859_4",
     ...
     * @param   encoding    java编码名称不区分大小写: <code>UTF8, 8859_1, 8859_2, 8859_3,
     *                      8859_4, 8859_5, 8859_6, 8859_7, 8859_8, 8859_9, JIS, SJIS, EUCJIS,
     *                      GB2312, BIG5, KSC5601, ISO2022KR, KOI8_R, CP037, CP277, CP278,
     *                      CP280, CP284, CP285, CP297, CP420, CP424, CP500, CP870, CP871
     *                      and CP918</code>.
     * @return              MIME字符集名称, 或者<var>null</var>如果<var>encoding</var>未知.
     */
