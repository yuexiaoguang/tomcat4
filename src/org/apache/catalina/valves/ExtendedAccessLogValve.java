 ...
 * <li><code>x-P(...)</code>:  调用request.getParameter(...)并URL编码它. 有助于捕获某些POST参数.
 * </li>
 ...
 * </p>
 */
public final class ExtendedAccessLogValve extends ValveBase implements Lifecycle {
    ...
    private Date getDate(long systime) {
        /* 避免额外调用System.currentTimeMillis(); */
        if (0==systime) {
