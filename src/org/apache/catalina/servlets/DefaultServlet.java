...
public class DefaultServlet extends HttpServlet {
    ...
    /**
     * SimpleDateFormat格式集合，用于getDateHeader().
     */
    ...
    /**
     * 获取资源. 该方法将首先检索资源通过JNDI, 然后是servlet上下文，如果JNDI失败 (它可以被禁用). 它将返回null.
     *
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp)
        ...
        // 临时输入流. content file used to support partial PUT
     ...
     *
     * @param resourceInfo File object
     * @param strong True 如果我们想要一个强大的ETag, 在这种情况下，必须计算文件的校验和
     */
    ...
    /**
     * 返回上下文相对路径, "/"开头, 表示指定路径的规范版本，在 ".." 和 "."元素被处理之后.
     * 如果指定的路径试图超出当前上下文的边界(即太多 ".." 路径元素存在), 返回<code>null</code>.
     *
    ...
    protected void serveResource(HttpServletRequest request,
        ...
        // 如果资源是一个集合(aka a directory), 检查欢迎文件列表.
        if (resourceInfo.collection) {
    ...
    /**
     * 将请求参数追加到重定向字符串中，在调用sendRedirect之前.
     */
     ...
     * @param resourceInfo The ResourceInfo object
     * @param ostream The output stream to write to
     * @param ranges 客户端要检索的范围的枚举
     * @param contentType 内容类型的资源
     * @exception IOException if an input/output error occurs
     */
    private void copy(ResourceInfo resourceInfo, ServletOutputStream ostream,
