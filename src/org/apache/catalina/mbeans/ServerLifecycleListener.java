...
/**
 * <code>LifecycleListener</code>实现类，实例化Catalina的运行实例组件相关的MBeans集合
 */
public class ServerLifecycleListener
    ...
    /**
     * 挑选一个Container处理一个<code>ContainerEvent</code>.
     *
    ...
    public void lifecycleEvent(LifecycleEvent event) {
        ...
        if (Lifecycle.START_EVENT.equals(event.getType())) {
            ...
            */
            ...
            // 提供上下文的MBean服务器一个新控制, 如果上下文已经重新加载, 由于重载导致上下文失去对服务器的先前控制
            if (lifecycle instanceof StandardContext) {
                // 如果上下文是特权的, 在servlet上下文属性中引用它
    ...
    /**
     * 挑选一个Container处理<code>PropertyChangeEvent</code>.
     *
     * @param event The event that has occurred
     */
    ...
    /**
     * 创建MBeans，给指定的Connector 及其嵌套组件
     *
     * @param connector Connector for which to create MBeans
     *
     * @exception Exception 如果创建MBean期间发生异常
     */
    ...
    /**
     * 创建MBeans，给指定的ContextEnvironment entry.
     *
    ...
    /**
     * 创建MBeans，给指定的ContextResource entry.
     *
    ...
    /**
     * 创建MBeans，给指定的ContextResourceLink entry.
     *
    ...
    /**
     * 创建MBeans，给指定的DefaultContext及其嵌套组件
     *
    ...
    /**
     * 创建MBeans，给指定的NamingResources及其嵌套组件
     *
    ...
    /**
     * 注销MBeans，为指定的Connector及其嵌套组件
     *
     * @param connector Connector for which to deregister MBeans
     *
     * @exception Exception 如果注销MBean期间发生异常
     */
    ...
    /**
     * 注销MBeans，为指定的ContextEnvironment entry.
     *
    ...
    /**
     * 注销MBeans，为指定的ContextResource entry.
     *
    ...
    /**
     * 注销MBeans，为指定的ContextResourceLink entry.
     *
    ...
    /**
     * 注销MBeans，为指定的DefaultContext及其嵌套组件
     *
    ...
    /**
     * 注销MBeans，为指定的NamingResources及其嵌套组件
     *
     ...
     * @param propertyName 修改的属性名
     * @param oldValue 之前的值(可能是<code>null</code>)
     * @param newValue 新值(可能是<code>null</code>)
     *
    ...
    /**
     * 处理NamingResources的属性修改事件.
     *
     * @param resources 发生事件的全局命名资源
     * @param propertyName 修改的属性名
     * @param oldValue 旧值(可能是<code>null</code>)
     * @param newValue 新值(可能是<code>null</code>)
     *
